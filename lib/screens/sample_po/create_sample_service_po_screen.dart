...
class CreateSampleServicePOScreen extends StatefulWidget {
  const CreateSampleServicePOScreen({Key? key, required this.openDrawer})
      : super(key: key);
  final VoidCallback openDrawer;

  @override
  _CreateSampleServicePOScreenState createState() =>
      _CreateSampleServicePOScreenState();
}

class _CreateSampleServicePOScreenState
    extends State<CreateSampleServicePOScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('Create Sample Service PO'),
