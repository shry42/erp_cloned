import 'package:erp_copy/controllers/gis_controllers/get_gis_all_list_controller.dart';
...
class GISStatusListcreen extends StatefulWidget {
  const GISStatusListcreen({
    super.key,
  ...
  @override
  State<GISStatusListcreen> createState() => _GISStatusListcreenState();
}

class _GISStatusListcreenState extends State<GISStatusListcreen> {
  TextEditingController searchController = TextEditingController();

  final GetGisAllListController gaglc = GetGisAllListController();
    ...
    setState(() {
      if (query.isEmpty) {
        ...
        filteredItemList = itemList.where((item) {
          return (item.gisTxnID?.toString().toLowerCase().contains(query) ??
              false);
        }).toList();
      }
    });
