...
class MyGISApprovalScreen extends StatefulWidget {
  const MyGISApprovalScreen({super.key, required this.openDrawer});

  final VoidCallback openDrawer;

  @override
  _MyGISApprovalScreenState createState() => _MyGISApprovalScreenState();
}

class _MyGISApprovalScreenState extends State<MyGISApprovalScreen> {
