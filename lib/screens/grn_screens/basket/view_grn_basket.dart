...
class ViewGRNBasketScreen extends StatefulWidget {
  const ViewGRNBasketScreen({
    super.key,
    this.remark,
    this.invoiceNumber,
    this.grnNumber,
  ...
  @override
  State<ViewGRNBasketScreen> createState() => _ViewGRNBasketScreenState();
}

class _ViewGRNBasketScreenState extends State<ViewGRNBasketScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('GRN Basket Items'),
      ),
      body: Padding(
              ...
              child: Obx(() {
                return SingleChildScrollView(
                  ...
                  child: DataTable(
                    ...
                    rows: grnBasketController.basketItems
                        .asMap()
                        .entries
                        .map((entry) {
                      int index = entry.key;
                      GRNBasketItem item = entry.value;
                      ...
                      return DataRow(cells: [
                        ...
                        DataCell(Text(item.venusId ?? 'N/A')),
                        DataCell(Text(item.itemGroup ?? 'N/A')),
                        DataCell(Text(item.itemId ?? 'N/A')),
                        ...
                        DataCell(TextFormField(
                          ...
                          onChanged: (value) {
                            grnBasketController.updateBatchNumber(index, value);
                          },
                        )),
                        DataCell(TextFormField(
                          ...
                          onChanged: (value) {
                            grnBasketController.updateSerialNumber(
                                index, value);
                          },
                        )),
                        ...
                        DataCell(TextFormField(
                          ...
                          onChanged: (value) {
                            grnBasketController.updateReceivedQuantity(
                                index, value);
                          },
                        )),
                        ...
                        DataCell(TextFormField(
                          ...
                          onChanged: (value) {
                            grnBasketController.updateReceivedRate(
                                index, value);
                          },
                        )),
                            ...
                            return DropdownButton<int>(
                              ...
                              onChanged: (newValue) {
                                ...
                                setState(() {
                                  ...
                                  grnBasketController.updateGateEntryId(
                        ...
                        DataCell(Text(item.acceptedQuantity ?? 'N/A')),
                        DataCell(
                          IconButton(
                            icon: const Icon(Icons.delete, color: Colors.red),
                            onPressed: () {
                              grnBasketController.removeItemFromBasket(index);
                            },
                          ),
                        ),
                      ]);
              ...
              children: [
                ElevatedButton(
                  onPressed: () {
                    ...
                    grnBasketController.submitGRNBasket(
                ...
                ElevatedButton(
                  onPressed: () {
                    ...
                    grnBasketController.resetBasket();
                  },
                  style: ElevatedButton.styleFrom(
