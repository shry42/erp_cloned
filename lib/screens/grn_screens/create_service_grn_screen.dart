...
import 'package:erp_copy/screens/grn_screens/basket/view_service_grn_basket.dart';
import 'package:erp_copy/screens/grn_screens/default_dialog_screen/service_dialog_screen.dart';
...
class CreateServiceGRNScreen extends StatefulWidget {
  const CreateServiceGRNScreen({Key? key, required this.openDrawer})
      : super(key: key);
  final VoidCallback openDrawer;

  @override
  _CreateServiceGRNScreenState createState() => _CreateServiceGRNScreenState();
}

class _CreateServiceGRNScreenState extends State<CreateServiceGRNScreen> {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        actions: [
          ElevatedButton(
            onPressed: () {
              Get.to(() => ViewServiceGRNBasketScreen(
                    invoiceNumber: _invoiceNumberController.text,
                    invoiceDate: _invoiceDateController.text,
            ...
            child: DropdownButtonFormField<VendorModel>(
              ...
              onChanged: (value) {
                ...
                _getPoLogByVendoridController.getPoLog(
                    selectedVendor.value!.vendorID!.toInt(), 'service');
              },
              validator: (value) {
                if (value == null) {
