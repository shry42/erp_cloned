...
import 'package:erp_copy/widget/add_item_group_widget.dart';
import 'package:erp_copy/widget/menu_widget/drawer_menu_widget.dart';
import 'package:erp_copy/widgets/Tables/item_group_table.dart';
import 'package:flutter/material.dart';
import 'package:flutter_advanced_drawer/flutter_advanced_drawer.dart';

class CreateItemGroupsScreen extends StatefulWidget {
  const CreateItemGroupsScreen({
    super.key,
  ...
  @override
  State<CreateItemGroupsScreen> createState() => _CreateItemGroupsScreenState();
}

class _CreateItemGroupsScreenState extends State<CreateItemGroupsScreen> {
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return Padding(
                          ...
                          child: ItemGroupTable(
                            ...
                            // wd: 400,
                            duration: 200,
                            name: snapshot.data[index].itemGroups,
                            type: snapshot.data[index].itemType,
                            prefix: snapshot.data[index].prefix.toString(),
                            suffix: snapshot.data[index].suffix.toString(),
                          ),
                        );
                      },
                    ),
