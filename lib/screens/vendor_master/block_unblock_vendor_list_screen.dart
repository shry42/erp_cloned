...
class BlockUnblockVendorListScreen extends StatefulWidget {
  const BlockUnblockVendorListScreen({
    super.key,
  ...
  @override
  State<BlockUnblockVendorListScreen> createState() =>
      _BlockUnblockVendorListScreenState();
}

class _BlockUnblockVendorListScreenState
    extends State<BlockUnblockVendorListScreen> {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Get.to(BlockUnblockVendorDetailsScreen(
                              selectedItem: vendor,
                            ));
                          },
                          child: Padding(
