...
import 'package:erp_copy/widgets/remark_dilaogs/unblock_vendor_remark_dilaog.dart';
import 'package:flutter/material.dart';

class BlockUnblockVendorDetailsScreen extends StatefulWidget {
  ...
  State<BlockUnblockVendorDetailsScreen> createState() =>
      _BlockUnblockVendorDetailsScreenState();
}

class _BlockUnblockVendorDetailsScreenState
    extends State<BlockUnblockVendorDetailsScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          if ((widget.selectedItem.isActive == 2 &&
            ...
            ElevatedButton(
              onPressed: () {
                showUnblockVendorDialog(widget.selectedItem.vendorID!.toInt());
              },
          ...
          if ((widget.selectedItem.isActive != 2 &&
            ...
            ElevatedButton(
              onPressed: () {
                showBlockVendorDialog(widget.selectedItem.vendorID!.toInt());
              },
