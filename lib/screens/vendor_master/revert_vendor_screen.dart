import 'package:erp_copy/controllers/vendor_master_controller/revert_vendor_controller.dart';
...
import 'package:erp_copy/screens/vendor_master/revert_vendor_details_screens_inside.dart';
import 'package:erp_copy/widget/menu_widget/drawer_menu_widget.dart';
import 'package:erp_copy/widget/vendor_cards/vendor_master_cards.dart';
import 'package:flutter/material.dart';
import 'package:get/get.dart';

class RevertVendorScreen extends StatefulWidget {
  const RevertVendorScreen({
    super.key,
  ...
  @override
  State<RevertVendorScreen> createState() => _RevertVendorScreenState();
}

class _RevertVendorScreenState extends State<RevertVendorScreen> {
  TextEditingController searchController = TextEditingController();
  final RevertVendorController gvmc = RevertVendorController();
  final _formKey = GlobalKey<FormState>();

  List<RevertVendorListModel> vendorList = [];
  List<RevertVendorListModel> filteredVendorList = [];
  ...
  void _loadVendorData() async {
    var data = await gvmc.getRevertVendor();
    setState(() {
      vendorList = data;
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        ...
                        return GestureDetector(
                          onTap: () {
                            Get.to(RevertVendorDetailsScreenInside(
                              selectedItem: vendor,
                            ));
                          },
                          child: Padding(
