...
class StockPostingScreen extends StatefulWidget {
  const StockPostingScreen({super.key, required this.openDrawer});

  final VoidCallback openDrawer;

  @override
  _StockPostingScreenState createState() => _StockPostingScreenState();
}

class _StockPostingScreenState extends State<StockPostingScreen> {
