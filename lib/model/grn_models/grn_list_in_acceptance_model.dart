class GRNListInAcceptanceModel {
  int? grnDetailsID;
  double? acceptedQty;
  int? poTxnID;
  String? poCode;
  ...
  factory GRNListInAcceptanceModel.fromJson(Map<String, dynamic> json) {
    return GRNListInAcceptanceModel(
