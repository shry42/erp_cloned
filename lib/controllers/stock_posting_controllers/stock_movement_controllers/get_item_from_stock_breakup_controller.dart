  ...
  getItemstockBrkp(int itemId) async {
    ...
    try {
      http.Response response = await http.post(
        Uri.parse('${ApiService.base}/api/getItemFromStockBreakup'),
        headers: {
      ...
      if (response.statusCode == 200) {
        ...
        Map<String, dynamic> itemDetails = result['itemDetails'];
        ...
        itemDetailsList.value = [
          ItemDetailsFromStockBrkpModel.fromJson(itemDetails)
        ];
        selectedVenusid.value = itemDetails['SAP_ID'];
        isActive.value = itemDetails['isActive'];
